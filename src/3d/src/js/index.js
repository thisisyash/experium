...
const respiration = new Audio("sounds/respiration1.mp3")
...
// Dark Vador
gltfLoader.load(
    './models/Dark_vador/2k/final.glb',
    (gltf) => {
    ...
    async (error) => {
        ...
        const debugContent = await debugFetchGLTF('./models/Dark_vador/2k/final.glb');
        if (debugContent) {
